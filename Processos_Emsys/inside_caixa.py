...
class Caixa():
    ...
    def rateio(valor):
        ...
        while cont <= valor:
            ...
            if rateio == '0':
                ...
                print('Não foi possivel pegar o operador!')
            else:
    ...
    def confirmar(caixas):
        cont = 1
        while cont <= caixas:
            print('')
            print(f'Procedimento n° {cont} de {caixas}')
            print('+=' * 20)
            sleep(0.5)
            ...
            px.write("y")
            sleep(6)
            print("Clicando para finalizar")
            px.press("enter")
                
            if cont < caixas:
                sleep(6)
                print("Clicando para próximo caixa")
        ...
        print('')
        sleep(3)
        print('Fechando o Fechamento de caixa')
        px.click(1037,65, duration=0.5)
        sleep(2)
        px.click(862,189)
        sleep(2)
